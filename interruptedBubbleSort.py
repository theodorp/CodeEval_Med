...
# line in this file contains a space-separated list of positive integers and
# ends with a number of iterations, separated by vertical line ‘|’. E.g.:
...
def interruptedBubbleSort(test):

	line, count = test.split('|')
	count = int(count)
...
test_cases = open('interruptedBubbleSort.txt','r')
...
for test in test_cases:
	...
	if not test.strip():
		...
		seq = interruptedBubbleSort(test)
